			...
			<form method="POST" action="{{ route('admin.slider.update', $data->id) }}" accept-charset="UTF-8">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<p>Định dạng jpg, jpeg, png. Tên thư mục & ảnh phải là không dấu, không chứa dấu cách + kí tự đặc biệt. Dung lượng ảnh nhẹ (< 1mb)<br>Auto crop thumbnail: 400x400</p>
						<p>Kích cỡ:</p>
						<ul>
							<li>Slider đầu trang: 760x360</li>
