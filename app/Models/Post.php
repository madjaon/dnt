...
class Post extends Model
{
    ...
    protected $fillable = [
        'name', 'slug', 'type_main_id', 'seri', 'related', 'type', 'url', 'price', 'price_old', 'discount', 'summary', 'description', 'post_images', 'image', 'meta_title', 'meta_keyword', 'meta_description', 'meta_image', 'position', 'source', 'source_url', 'start_date', 'view', 'status', 'lang',
    ];
